...
{capture assign='headerNavigation'}
	<li>
		<a rel="alternate"
		   href="{if $__wcf->getUser()->userID}{link application='cms' controller='NewsFeed' id=$category->categoryID appendSession=false}at={@$__wcf->getUser()->userID}-{@$__wcf->getUser()->accessToken}{/link}{else}{link application='cms' controller='NewsFeed' id=$category->categoryID appendSession=false}{/link}{/if}"
...
<div class="contentNavigation">
	...
	{if $category->getPermission('canAddNews')}
		<nav>
			<ul>
				<li>
					<a href="{link application='cms' controller='NewsAdd' id=$categoryID}{/link}"
