					...
					{if $categoryItem->isAccessible()}
                        <li{if $category|isset && $category->categoryID == $categoryItem->categoryID} class="active"{/if}>
                            <a href="{$categoryItem->getLink()}" class="boxMenuLink">
                                ...
                                <span class="badge{if $categoryItem->getUnreadNews()} badgeUpdate{/if} newsCounter">{if $categoryItem->getUnreadNews()}{#$categoryItem->getUnreadNews()}/{/if}{#$categoryItem->getNews()}</span>
                            </a>
										...
										{if $subCategoryItem->isAccessible()}
                                            <li{if $category|isset && $category->categoryID == $subCategoryItem->categoryID} class="active"{/if}>
                                                <a href="{$subCategoryItem->getLink()}" class="boxMenuLink">
                                                    ...
                                                    <span class="badge{if $subCategoryItem->getUnreadNews()} badgeUpdate{/if} newsCounter">{if $subCategoryItem->getUnreadNews()}{#$subCategoryItem->getUnreadNews()}/{/if}{#$subCategoryItem->getNews()}</span>
                                                </a>
                                            </li>
										{/if}
									{/foreach}
