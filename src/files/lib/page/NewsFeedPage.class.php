...
class NewsFeedPage extends AbstractFeedPage
{
     ...
     * {@inheritdoc}
     *
     * @throws \wcf\system\exception\IllegalLinkException if a list of category ids was given with this request but at least one id does not belong to a existing category.
     * @throws \wcf\system\exception\PermissionDeniedException if a list of category ids was given with this request but at least one category is not accessible by the current user.
     */
