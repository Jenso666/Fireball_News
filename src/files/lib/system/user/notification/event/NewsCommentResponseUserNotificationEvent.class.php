...
class NewsCommentResponseUserNotificationEvent extends AbstractUserNotificationEvent {
	...
	public function getMessage() {
		...
		if (count($authors) > 1) {
			...
			return $this->getLanguage()->getDynamicVariable('cms.news.commentResponse.notification.message.stacked', array('news' => $news, 'author' => $this->author, 'authors' => array_values($authors), 'count' => $count, 'others' => $count - 1, 'guestTimesTriggered' => $this->notification->guestTimesTriggered,));
		}
